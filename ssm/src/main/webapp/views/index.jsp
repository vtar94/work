   ...
   <div class="layout-admin">
			...
			<ul class="header-bar">
				...
				<li class="header-bar-nav">
					<!--<a href="javascript:;">admin<i class="icon-font" style="margin-left:5px;">&#xe60c;</i></a>-->
						...
						<li><a href="views/login.jsp" onclick="return confirm('您确定要退出系统吗？');">退出</a></li>
		...
		<section class="layout-main">
			...
			<div class="layout-main-body">
				<iframe class="body-iframe" name="iframe0" width="100%" height="99%" src="views/home.jsp" frameborder="0" data-id="views/sc1.jsp" seamless></iframe>
			</div>
		</section>
		<div class="layout-footer">@2018 廊坊数字空间科技有限公司</div>
	</div>
